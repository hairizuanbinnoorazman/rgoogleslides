...
#' Delete text to shapes/tables
#' @inheritParams build_delete_text
#' @param id ID of the presentation slide
#' @export
delete_text <- function(id=NULL, objectId=NULL, rowIndex=NULL, columnIndex=NULL,
                        startIndex = NULL, endIndex = NULL,
                        type = NULL){
  # Create the list object
  requests_list <- build_delete_text(objectId, rowIndex, columnIndex, startIndex, endIndex, type)
  result_list <- post_batchUpdate(id, requests_list)
  return(result_list)
}
